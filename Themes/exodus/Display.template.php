			...
			<div id="forumposts">
				<div class="display-info alert alert-exodus">
					...
					<ul class="reset"> 
						...
						{
							echo '<li class="h4 alert"><i class="fa fa-lock fa-fw"></i>Locked</li>';
						}
					echo '
					</ul>
				</div>';
...
// Show the profile, website, email address, and personal message buttons.
		...
		echo '
				...
				echo '
						...
						//echo 'pe'. $message['id'];
						//echo 'pe'. $context['first_message'];
						if ($message['id'] == $context['first_message'])
//						echo '<div style="float:right;margin:0px">
//								<fb:like href="',$scripturl ,'?topic=',$context['current_topic'],'.0" send="true" data-layout="button_count" data-action="like" data-show-faces="true" data-share="true"></fb:like> 
//								<fb:send data-href="',$scripturl ,'?topic=',$context['current_topic'],'.0"></fb:send><br />
//								<a href="https://twitter.com/share" class="twitter-share-button" data-hashtags="siamspeed">Tweet</a> <script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0],p=/^http:/.test(d.location)?\'http\':\'https\';if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src=p+\'://platform.twitter.com/widgets.js\';fjs.parentNode.insertBefore(js,fjs);}}(document, \'script\', \'twitter-wjs\');</script><br />
//								<div class="g-plus" data-action="share" data-annotation="none"></div>
//							</div>';
						echo '<div style="float:right;margin:0px">
								<div class="fb-like" data-href="',$scripturl ,'?topic=',$context['current_topic'],'.0" data-layout="button_count" data-action="like" data-show-faces="true" data-share="true"></div>
								<div class="fb-send" data-href="',$scripturl ,'?topic=',$context['current_topic'],'.0"></div>
							</div>';
//						else
...
//					echo '
//										<br><br><div class="fb-like" data-href="', $context['canonical_url'], '" data-layout="button_count" data-action="like" data-show-faces="true" data-share="true"></div>';
				...
				//if ($message['id'] == $context['first_message']) { include("API/googleAdSense3"); }
				echo '
				<hr  />';
	}
	echo '
